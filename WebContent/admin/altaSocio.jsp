			...
			<div id="menu">
				<jsp:directive.include file="../WEB-INF/menu.jspf"/>
					...
					<c:if test="${requestScope.confirmacion!=null}"> 
						...
						<form action="${pageContext.request.contextPath}/Controller" method="post" class="form" id="tabla">
							<fieldset>
								...
								<table border="0">
									...
									<tr>
										...
										<td width=50%><input type="password" name="CLAVE"/></td> 
									</tr>
									
									<tr>
										<td width=50%>DIRECCION</td> 
										<td width=50%><input type="text" name="DIRECCION"/></td> 
									</tr>
								...
								<input class="boton" type="hidden" value="altaSocio" name="operacion" />
