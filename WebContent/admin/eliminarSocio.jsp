	...
	<div id="container">
		...
		<c:if test="${not empty listadoSocios}">
						...
						<tr>
							...
							<c:forEach var="socios" items="${listadoSocios}">
								<tr>
									...
									<td width="15%"><a href="${pageContext.request.contextPath}/Controller?operacion=mSocioEliminar&IDSOCIO=${socios.IDSOCIO}">Eliminar</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
				...
				<div class="encabezadoTabla" align="center">
					<font color="#FFFFFF";>
					<h2>El socio <c:out value="${id}"></c:out></h2>
					</font>
				</div>
